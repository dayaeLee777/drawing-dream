  ...
  useEffect(() => {
    getScore().then((res) => {
      ...
      for (idx; idx < score.length; idx++) {
        ...
        score_temp[_grade * 4 + _semester * 2 + _class] =
          score_temp[_grade * 4 + _semester * 2 + _class] + score[idx].score;
        subject_temp[_grade * 4 + _semester * 2 + _class] =
          subject_temp[_grade * 4 + _semester * 2 + _class] + 1;
