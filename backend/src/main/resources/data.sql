...
(unhex(replace(uuid(),'-','')),'J05',0,'2022-02-14','E00','O02','2022-02-14',NULL,_binary 'm®rL®§u,bÚ¶'),
(unhex(replace(uuid(),'-','')),'J02',0,'2022-02-11','E00','O02','2022-02-11',NULL,_binary 'm®rL®§u,bÚ¶');
