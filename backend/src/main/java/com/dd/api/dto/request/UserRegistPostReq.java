...
public class UserRegistPostReq {
	...
	public Auth toAuthEntity() {
		return new Auth(loginId, password);
	}
	
	public User toUserEntity() {
		return new User(userName, userEmail, address, phone, parentPhone);
	}
	
	public UserDepartment toUserDepartmentEntity() {
		return new UserDepartment(schoolName, gradeCode, classCode, studentNo);
	}
}
