...
@ApiModel("TimeTableGetListResponseDTO")
@Getter
@ToString
public class TimeTableGetListResponseDTO {
	...
	@Builder
	public TimeTableGetListResponseDTO(UUID timeTableId, Code dayCode, Code periodCode, Code semesterCode,
			UUID courseId, SubCode courseCode) {
		super();
