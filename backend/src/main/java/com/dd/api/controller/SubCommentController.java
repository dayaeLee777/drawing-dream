...
//		commentService.registerComment(accessToken, CommentRegisterRequestDto);
		subCommentService.registerSubComment(subCommentRegisterRequestDto);
...
//		SubCommentGetListResponseDto subCommentGetListResponseDto = subCommentService.getSubCommentList(accesstoken, commentId);
...
//		commentService.updateComment(accessToken, commentUpdateRequestDto);
		if(!subCommentService.updateSubComment(commentUpdateRequestDto)) {
...
//			@ApiIgnore @RequestHeader("Authorization") String accessToken,
		...
		if(!subCommentService.deleteSubComment(commentId)) {
