...
public class MyClassController {
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "회원 목록을 정상적으로 불러왔습니다."),
	...
	public ResponseEntity<? extends BaseResponseDto> getMyClassList(
		...
		return ResponseEntity.status(200).body(
				MyClassGetListWrapperResponseDto.of(200, "회원 목록을 정상적으로 불러왔습니다", myClassGetListWrapperResponseDto));
	}
}
